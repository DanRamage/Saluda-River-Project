...
class wq_sample_data_collector_plugin(my_plugin.data_collector_plugin):
    ...
    def __init__(self):
        ...
        self.output_queue = None
        self.email_only_on_file_download = False
        self.monitor_mailhost = ""
        self.port = ""
        self.monitor_fromaddr = ""
        self.monitor_toaddrs = ""
        self.monitor_subject = ""
        self.monitor_user = ""
                ...
                try:
                    ...
                    for wq_file in wq_data_files:
                        ...
                        if exten == '.xls' or exten == '.xlsx':
                            ...
                            new_filename = os.path.join(file_path, "%s-sample_results%s" % (
                            sample_date.strftime("%Y-%m-%d"), file_ext))
